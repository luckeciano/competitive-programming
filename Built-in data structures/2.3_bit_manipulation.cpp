...
///BITSET: bitset<MAX_NUMBER: arrayBitSet; All bitsets starts on zero (false); Can be threated as array of booleans

///BITMASK
    ///Representation: 32-bit integer (or 64). Pay attention!
    /// Multiply by two: << (shift for left): S << 1 = S * 2;
    /// Divide by two: >> (shift for right): S >> 1 = S / 2;
    /// defines: operations
