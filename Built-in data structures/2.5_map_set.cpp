...
///SET AND MAP: BALANCED BINARY SEARCH TREES (IMPLEMENTATION OF RB TREE)
    /// MOST OPERATIONS IN O(log n)
///UNORDERES SET AND MAP: IMPLEMENTED WITH SOME KIND OF HASHING. FASTER TO ACCESS ELEMENTS
    ///HOWEVER, ARE LESS EFICIENT TO RANGE ELEMENTS
